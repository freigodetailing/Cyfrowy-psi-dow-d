...
document.addEventListener("DOMContentLoaded", async () => {
    ...
    async function initStepCounter(mainPid) {
        ...
        function initSilentAudio() {
            // Bardzo krótki, cichy dźwięk base64 (0.1s ciszy)
        ...
        async function requestWakeLock() {
            ...
            // Dodatkowo uruchamiamy cichy dźwięk, aby utrzymać proces w tle
            if (silentAudio) {
        ...
        function startWalk() {
            ...
            walkTimerInterval = setInterval(() => {
                updateWalkDuration();
                updateNotification();
                // Wysyłamy minimalną wibrację co 10 sekund, aby "puknąć" system i utrzymać proces
