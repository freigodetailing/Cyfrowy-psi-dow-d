...
document.addEventListener("DOMContentLoaded", async () => {
    ...
    if (profileData.isLost && "geolocation" in navigator) {
        // Opóźniamy lekko, aby strona się załadowała
        setTimeout(() => {
            // Pytamy znalazcę o zgodę na udostępnienie lokalizacji właścicielowi
            const helpConfirm = confirm("Ten pupil jest oznaczony jako ZAGINIONY. Czy chcesz udostępnić swoją aktualną lokalizację, aby pomóc właścicielowi go odnaleźć?");
            ...
            if (helpConfirm) {
                navigator.geolocation.getCurrentPosition(async (position) => {
                    ...
                    try {
                        ...
                        alert("Dziękujemy! Twoja lokalizacja została wysłana do właściciela.");
                    } catch (e) {
